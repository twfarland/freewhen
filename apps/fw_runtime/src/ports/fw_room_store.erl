...
The adapter today is `fw_directory`, an ETS table cleaned up by monitors; one
that shards by hash across machines would change this and nothing above it. The
implementation is chosen in `fw_settings`, so a test can supply its own.
""".
